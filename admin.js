...
const CREATOR_NAMES = {
  mightymagulang:  { name: 'Mighty Magulang',  category: 'entertainment' },
  exposed:         { name: 'Exposed',           category: 'entertainment' },
  leomiho:         { name: 'Leomiho',           category: 'entertainment' },
  renzomaano:      { name: 'renzomaano',        category: 'entertainment' },
  geloyconcepcion: { name: 'Geloy Concepcion',  category: 'influencer'    },
