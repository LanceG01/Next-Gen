...
// ===== CALCULATING TALLY OVERLAY =====
function showCalculatingOverlay(duration = 3000) {
...
async function runSequentialReveal() {
  ...
  // Show "Calculating Tally" before anything else
  await showCalculatingOverlay(3200);
  ...
  for (let i = 0; i < CATEGORY_ORDER.length; i++) {
    ...
    await countUpCategory(cat, 4000);
